...
# launch_runs impl_1 impl_2 -to_step write_bitstream -jobs 1
# launch_runs [get_runs *child_impl_*_constr_*] -to_step write_bitstream -jobs 1
...
launch_runs $child_runs_all -to_step write_bitstream -jobs 1
