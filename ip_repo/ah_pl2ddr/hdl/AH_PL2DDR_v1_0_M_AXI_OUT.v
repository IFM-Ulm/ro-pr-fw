...
`timescale 1 ns / 1 ps
	...
	module AH_PL2DDR_v1_0_M_AXI_OUT #
	(
	...
	(
		...
		output wire data_next,
		
		input wire [31:0]  C_M_TARGET_SLAVE_BASE_ADDR,
		input wire [8:0] C_M_AXI_BURST_LEN,
		input wire [10:0] C_NO_BURSTS_REQ,
	...
	//Example design I/O
	assign TXN_DONE	= writes_done && !init_txn_pulse;
	assign ERROR = 0;
	//Burst size in bytes
	 ...
	 // against the number of burst transactions the master needs to initiate                                   
	  ...
	  begin                                                                                                     
	    if (M_AXI_ARESETN == 0 || init_txn_pulse == 1'b1 )                                                                                 
	      ...
	      begin                                                                                                                                                
	        if (write_burst_counter < C_NO_BURSTS_REQ)                                                   
	          begin                                                                                             
