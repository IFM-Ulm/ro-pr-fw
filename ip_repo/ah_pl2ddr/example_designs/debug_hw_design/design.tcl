...
proc create_ipi_design { offsetfile design_name } {
	...
	set AH_PL2DDR_0 [ create_bd_cell -type ip -vlnv uni-ulm.de:user:AH_PL2DDR:1.0 AH_PL2DDR_0 ]
	...
	# Connect all clock, reset & status pins of AH_PL2DDR_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins AH_PL2DDR_0/M_AXI_OUT]
	connect_bd_net [get_bd_pins AH_PL2DDR_0/m_axi_out_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AH_PL2DDR_0/m_axi_out_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins AH_PL2DDR_0/m_axi_out_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins AH_PL2DDR_0/m_axi_out_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins AH_PL2DDR_0/m_axi_out_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of AH_PL2DDR_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {AH_PL2DDR_0/M_AXI_OUT/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M_AXI_OUT_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells AH_PL2DDR_0]

	# Copy all address to AH_PL2DDR_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/AH_PL2DDR_v1_0_include.tcl"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores uni-ulm.de:user:AH_PL2DDR:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/AH_PL2DDR_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "AH_PL2DDR_v1_0_hw_${i}"
